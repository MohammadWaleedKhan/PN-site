...
export default function Footer() {
   useEffect(() => {
      document.querySelectorAll<HTMLElement>(".anim-top-to-bottom").forEach((el) => {
        gsap.timeline({
          scrollTrigger: {
    ...
    <footer id="mxd-footer" className="mxd-footer">
      ...
      <div className="mxd-footer__text-wrap">
        ...
        <div className="mxd-footer__fullwidth-text anim-top-to-bottom">
          ...
          viewBox="0 0 400.26 72" xmlSpace="preserve">
          <path d="M4.93,56V25.93H0V16h10.13v7.73h2.8c1.11-2.67,2.82-4.69,5.13-6.07c2.31-1.38,4.96-2.07,7.93-2.07h3.33v8.53h-3.8
            ...
            <div className="footer-blocks__nav">
              <ul className="footer-nav">
                <li className="footer-nav__item anim-uni-in-up">
                  <a href="index-main.html" className="footer-nav__link btn-anim">
                ...
                <li className="footer-nav__item anim-uni-in-up">
                  <a href="works-simple.html" className="footer-nav__link btn-anim">
                ...
                <li className="footer-nav__item anim-uni-in-up">
                  <a href="services.html" className="footer-nav__link btn-anim">
          ...
          <div className="footer-blocks__card fullheight-card">
            ...
            <div className="footer-blocks__links anim-uni-in-up">
              <p className="t-xsmall t-muted">
                <a className="no-effect" href="https://1.envato.market/EKA9WD" target="_blank">Mix_Design</a>
