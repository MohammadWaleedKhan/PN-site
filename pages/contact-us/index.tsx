...
import IconImg1 from '../../public/images/icons/300x300_obj-cta-01.webp'
import IllustrationsImg1 from '../../public/images/illustrations/cta-img-01.webp'
import IllustrationsImg2 from '../../public/images/illustrations/cta-img-02.webp'
                  ...
                  <div className="mxd-block__content">
                    <div className="mxd-block__inner-headline loading__item">
                      <h1 className="inner-headline__title">
                        ...
                        {/* <!-- <a className="btn btn-line-headline slide-right-up anim-no-delay" href="mailto:example@example.com?subject=Message%20from%20your%20site">
                      ...
                      <p className="inner-headline__text t-large t-bright loading__item">Have questions? We've got the answers!
                    ...
                    <div className="mxd-block__inner-form loading__fade">
                      <div className="form-container">
                        ...
                        <div className="form__reply centered text-center">
                          ...
                          {/* <!-- <i className="ph-fill ph-smiley reply__icon"></i> --> */}
      ...
      <div className="mxd-section padding-grid-pre-mtext">
        <div className="mxd-container">
          <div className="mxd-divider">
            <div className="mxd-divider__image divider-image-3 parallax-img"></div>
          </div>
        </div>
      </div>
            ...
            <div className="mxd-links-lines">
              ...
              <div className="mxd-links-lines__item">
                ...
                <a className="mxd-links-lines__link anim-uni-in-up" href="https://dribbble.com/" target="_blank">
                  <h6 className="mxd-links-lines__title">Dribbble</h6>
              ...
              <div className="mxd-links-lines__item">
                ...
                <a className="mxd-links-lines__link anim-uni-in-up" href="https://www.behance.net/" target="_blank">
                  <h6 className="mxd-links-lines__title">Behance</h6>
                  <div className="mxd-links-lines__icon">
                    <i className="ph ph-arrow-up-right"></i>
                  </div>
                </a>
              ...
              <div className="mxd-links-lines__item">
                ...
                <a className="mxd-links-lines__link anim-uni-in-up" href="https://www.instagram.com/" target="_blank">
                  <h6 className="mxd-links-lines__title">Instagram</h6>
                  <div className="mxd-links-lines__icon">
                    <i className="ph ph-arrow-up-right"></i>
                  </div>
                </a>
              ...
              <div className="mxd-links-lines__item">
                ...
                <a className="mxd-links-lines__link anim-uni-in-up" href="https://github.com/" target="_blank">
                  <h6 className="mxd-links-lines__title">Github</h6>
                  <div className="mxd-links-lines__icon">
                    <i className="ph ph-arrow-up-right"></i>
                  </div>
                </a>
              ...
              <div className="mxd-links-lines__item">
                ...
                <a className="mxd-links-lines__link anim-uni-in-up" href="https://codepen.io/" target="_blank">
                  <h6 className="mxd-links-lines__title">Codepen</h6>
                  <div className="mxd-links-lines__icon">
                    <i className="ph ph-arrow-up-right"></i>
                  </div>
                </a>
              ...
              <div className="mxd-links-lines__item">
                ...
                <a className="mxd-links-lines__link anim-uni-in-up" href="https://www.figma.com/community" target="_blank">
                  <h6 className="mxd-links-lines__title">Figma community</h6>
                  <div className="mxd-links-lines__icon">
                    <i className="ph ph-arrow-up-right"></i>
                  </div>
                </a>
                ...
                <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                  <div className="mxd-block__content">
                    <div className="mxd-block__paragraph">
                      <p className="t-large t-bright anim-uni-in-up">Inspiring ideas, creative insights,
                            ...
                            <div className="col-12 col-md-6 col-xl-5 mxd-paragraph__lists-item">
                              ...
                              <ul>
                                <li className="anim-uni-in-up">
                                  <a className="anim-uni-in-up" href="https://goo.gl/maps/nWXKpGaDPuyH6gxRA" target="_blank">
            ...
            <div className="mxd-promo">
              <div className="mxd-promo__inner anim-zoom-out-container">
                ...
                <div className="mxd-promo__images">
                  <img className="promo-image promo-image-1" src={IllustrationsImg1.src} alt="Image" />
                  <img className="promo-image promo-image-2" src={IllustrationsImg2.src} alt="Image" />
                </div>
              </div>
            </div>
          </div>
